      ...
      <div className="relative flex flex-col w-full px-6 md:px-16 min-h-screen pt-24 lg:w-[calc(100vw-52%)]">
        <div className="w-full md:max-w-[480px] mx-auto pb-12">
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            <h1 className="text-black text-[32px] font-extrabold text-center tracking-[-1px] lg:text-5xl lg:tracking-[-2px]">
              Welcome back!
            </h1>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full mt-4">
              ...
              <button
                ...
                className={`text-white py-2 rounded-full transition-all ${isSubmitting ? 'bg-blue-300 cursor-not-allowed' : 'bg-blue-700 hover:cursor-pointer hover:bg-blue-800'
                  }`}
              >
                Login
              </button>
