...
const StoreMobile3DLoader = ({ onFinish }) => {
    ...
    return (
        <div
            className="min-h-screen bg-yellow-500 z-30"
            ...
            <div className="flex min-h-screen flex-col">
                <div className="flex-1">
                    ...
                    <main className="flex-grow overflow-auto px-4 pb-[6rem] pt-4 lg:pb-[11rem] lg:pt-6">
                        <div className="max-w-4xl w-full  rounded-2xl items-center p-4 bg-yellow-400 flex flex-col md:px-10 ">
                            ...
                            >
                                <div className="py-3 flex flex-col leading-4">
                                    <div className="text-lg text-center font-medium">Our Platforms</div>
                                </div>
                            </motion.div>
                            <motion.div
                                className=""
...
export default StoreMobile3DLoader;
