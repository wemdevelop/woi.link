                ...
                <div className="mx-auto w-full max-w-[512px] flex flex-col gap-6">
                  ...
                  <form className="flex flex-col gap-4 w-full">
                    <div className="relative w-full">
                      <input
                        id="fp_password_u_e"
                        name="fp_password_u_e"
                        type="email"
                        placeholder=" "
                        className="peer border-gray-300 w-full h-12 px-3 py-2 rounded-lg bg-gray-100 focus:bg-white focus:outline-none border  hover:border-black hover:border-2"
                      />
                      <label htmlFor="fp_password_u_e" className="woi_label_absolute_01">
                        username or email
                      </label>
                    </div>
